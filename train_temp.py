...
from modules.unet.model import UNet
...
class KittiDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        return DataLoader(self.trainset, batch_size=self.batch_size, shuffle=False, num_workers=20)
...
def main(config):
    ...
    # a = kittiData.train_dataloader()
    # b = kittiData.val_dataloader()
    # print(a)
